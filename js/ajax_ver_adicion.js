...
var idPlato=$("#platos").attr("value");
var idAdicion=$("#adicion").attr("value");
$.ajax({                                           // incio petición
    type: "POST",                                   //Cuando se haya enviado un formulario
    url: "script_anadir_plato_a_pedido.php",                               
    data: {id_plato:idPlato, id_adicion:idAdicion}                           //asigno el campo a la variable de peticion sql
    }).done(function( result ) {                         //recibo el resulta
    
});


//$.get("script_anadir_plato_a_pedido.php",{codigoP:idPlato, codigoA:idAdicion}); 
