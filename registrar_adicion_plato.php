                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " action="script_registrar_adicion_plato.php" id="signupForm" method="POST" enctype="multipart/form-data">
                                    <div class="form-group ">

                                        <label for="codigoAdicion" class="control-label col-lg-3">Código: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="codigoAdicion" name="codigoAdicion" type="text" required />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <label for="nombreAdicion" class="control-label col-lg-3">Nombre: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nombreAdicion" name="nombreAdicion" type="text" required />
                                        </div>

                                    </div>

                                    <div class="form-group ">
                                        <label for="precioAdicion" class="control-label col-lg-3">Precio: </label>
                                        <div class="col-lg-6">
                                            <div class="input-group m-bot15">
                                                <span class="input-group-addon">$</span>
                                                <input type="number" id="precioAdicion" name="precioAdicion" class="form-control" require>
                                    ...
                                    <div class="form-group ">
                                        <label for="nombreEmpresa" class="control-label col-lg-3">Plato: </label>
                                        <div class="col-lg-6">
                                        
                                        <?php if($rolIngresado == "admin"){?>

                                            <?php 
                                            $consulta_platos='select * from platos';
                                            $consulta=pg_query($conex,$consulta_platos);
                                              
                                            echo '<select class="form-control m-bot15" name="idPlato">';
                                            while($fila=pg_fetch_array($consulta)){
                                                echo "<option>".$fila['id_plato']." - ".$fila['nombre']." - ".$fila['id_empresa'].'</option>';
                                            }
                                            echo '</select>';
                                            ?>
                                       <?php }; ?>
                                       ...
                                       <?php if($rolIngresado == "Administrador"){?>
                                            ...
                                            echo '<select class="form-control m-bot15" name="idPlato">';
                                            while($fila=pg_fetch_array($consulta)){
                                                echo "<option>".$fila['id_plato'].'</option>';
                                            }
                                            echo '</select>';
                                            ?>
                                       <?php }; ?>
