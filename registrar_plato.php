                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " action="script_registrar_plato.php" id="signupForm" method="POST" enctype="multipart/form-data">
                                    <div class="form-group ">

                                        <label for="nombrePlato" class="control-label col-lg-3">Nombre: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nombrePlato" name="nombrePlato" type="text" required />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <label for="codigoPlato" class="control-label col-lg-3">Código: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="codigoPlato" name="codigoPlato" type="text" required />
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <label for="ingredientes" class="control-label col-lg-3">Ingredientes: </label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="ingredientes" name="ingredientes" type="text" required />
                                        </div>

                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-3">Fecha</label>
                                            <div class="col-md-6 col-xs-11" data-date-format="yyyy/mm/dd">
                                               
                                            <input type="text" name="fecha" id="datepicker" class='form-control datepick'/>
                                       
                                            </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="precioPlato" class="control-label col-lg-3">Precio: </label>
                                        <div class="col-lg-6">
                                            <div class="input-group m-bot15">
                                                <span class="input-group-addon">$</span>
                                                <input type="number" id="precioPlato" name="precioPlato" class="form-control">
                                    ...
                                    <div class="form-group">
                                             <label for ="imagenPlato"class="control-label col-md-3">Imagen Plato</label>
                                        <div class="col-md-9">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div>
                                                       ...
                                                       <input type="file" id="imagenPlato" name="imagenPlato"/>
                                                       </span>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <?php if($rolIngresado == "admin"){?>
                                            ...
                                            echo '<select class="form-control m-bot15" name="idEmpresa" required>';
