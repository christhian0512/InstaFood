     ...
     <script type="text/javascript">
      var datos = $.ajax({
        ...
        function dibujarGrafico() {
            ...
            hAxis: {title: 'Platos', titleTextStyle: {color: 'green'}},
            vAxis: {title: 'Número de Platos', titleTextStyle: {color: '#FF0000'}},
                                    ...
                                    <?php if($rolIngresado == "admin"){?>
                                            ...
                                            <li class="sub-menu" >
                                                ...
                                                <ul class="collapsed-nav closed">
                                                    ...
                                                    <li><a href="cancelar_plato.php">Cancelar Pedido</a></li>
                                                </ul>
                                            </li>
                     ...
                     <div class="form">
                            ...
                            <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class = 'btn btn-primary' name = 'graficaPlato' onclick="dibujarGrafico()">Graficar</button><br><br>
                                        </div>
                            </div>
                        </div>
