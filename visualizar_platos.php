                ...
                <section class="panel">
                    ...
                    <div class="box-head tabs">
                            <ul class="nav nav-tabs">
                                <li class='active'>
                                    <a href="#disponibles" data-toggle="tab">Disponibles</a>
                                </li>
                        ...
                        <fieldset >
                          <div class="alert alert-block alert-success fade in" id="addplato">
                           ...
                           <div class="table-responsive">
                            <div class="tab-content">
                                <div class="tab-pane active table-with-action" id="disponibles">
